...
\begin{figure}[ht]
  ...
  base-stacking interactinos are calculated for the neighboring bases.  The
  base-pairing interactions are considered for Watson-Crick pairs, namely, the A-T
  and G-C pairs.   Whereas the cross-stacking terms are only considered for
  bases next to the pairsing bases.}
